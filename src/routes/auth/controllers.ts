...
export const login: RequestHandler = async (req, res, next) => {
	...
	if (!user.validPassword(password)) return next(new HttpException(HttpStatusCode.NOT_FOUND, '비밀번호가 일치하지 않습니다'))
...
// [#] JWT
export const verifyToken: RequestHandler = async (req, res) => res.sendStatus(HttpStatusCode.SUCCESS)
